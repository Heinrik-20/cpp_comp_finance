...
double OracleEurOption::PriceByCRR(BinModel Model,
...
double OracleAmOption::PriceBySnell(BinModel Model,
   BinLattice<double>& PriceTree,
...
double OracleCall::Payoff(double z)
{
   if (z>K) return z-K;
   return 0.0;
}

int OraclePut::GetInputData()
{
...
double OraclePut::Payoff(double z)
{
   if (z<K) return K-z;
   return 0.0;
}
